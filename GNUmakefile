...
src/parallel-db.o : $(COMM_HDR) src/parallel-db.c include/parallel-db.h include/afl-fuzz.h
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) $(SPECIAL_PERFORMANCE) -c src/parallel-db.c -o src/parallel-db.o

src/parallel.o : $(COMM_HDR) src/parallel.c include/parallel.h include/afl-fuzz.h
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) $(SPECIAL_PERFORMANCE) -c src/parallel.c -o src/parallel.o

afl-fuzz: $(COMM_HDR) include/afl-fuzz.h $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/hashmap.c src/parallel-db.o src/parallel.o | test_x86
	$(CC) $(CFLAGS) $(COMPILE_STATIC) $(CFLAGS_FLTO) $(SPECIAL_PERFORMANCE) -Wno-shift-count-overflow $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/hashmap.c src/parallel.o src/parallel-db.o -o $@ $(PYFLAGS) $(LDFLAGS) -lm -lhiredis -lpthread
...
.PHONY: code-format
code-format:
	./.custom-format.py -i include/afl-fuzz.h
	./.custom-format.py -i include/debug.h
	./.custom-format.py -i include/parallel-db.h
	./.custom-format.py -i include/parallel.h
	
	./.custom-format.py -i instrumentation/SanitizerCoverageLTO.so.cc

	./.custom-format.py -i src/afl-fuzz-bitmap.c
	./.custom-format.py -i src/afl-fuzz-init.c
	./.custom-format.py -i src/afl-fuzz-queue.c
	./.custom-format.py -i src/afl-fuzz-run.c
	./.custom-format.py -i src/afl-fuzz-state.c
	./.custom-format.py -i src/afl-fuzz-stats.c
	./.custom-format.py -i src/afl-fuzz.c
	./.custom-format.py -i src/parallel-db.c
	./.custom-format.py -i src/parallel.c
	./.custom-format.py -i src/afl-fuzz-one.c
